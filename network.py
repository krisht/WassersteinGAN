...
class WGAN:
    ...
    def build_net(self, input_size, clip_rate, learning_rate):
        ...
        self.train_critic = tf.train.RMSPropOptimizer(learning_rate=learning_rate).minimize(critic_err, var_list=critic_var)

        self.sess.run(tf.global_variables_initializer())

    #Train a single iteration
    def train_iteration(self, batch_size, critic_loops, noise_size, images):
        #Train critic first
    ...
    def generate_image(self, num_images):
        ...
        self.sess.run(self.generated_MNIST, feed_dict={self.input_noise:input_noise})
